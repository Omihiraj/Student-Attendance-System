...
const char *password = "3HH6BAG08T9";
//************************************************************************
String postData ; 
String link = "http://192.168.8.102/bio/getdata.php"; 
int FingerID = 0;     
uint8_t id;
uint8_t ss=1;
int log_on = 0;
...
void sent_get(){
  ...
  //Post Data
  postData = "confirm_id=" + String(ss); // Add the Fingerprint ID to the Post array in order to send it
  // Post methode
  ...
  if (payload.substring(0, 6) == "set_id") {
...
void SendFingerprintID( int finger ){
  ...
  if (payload.substring(0, 5) == "login") {
    String user_name = payload.substring(5,20 );
